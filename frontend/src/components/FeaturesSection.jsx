...
const FOOD_ITEMS = [
  {
    ...
    titleKey: "features.items.pizza.title",
    descKey: "features.items.pizza.desc",
    price: "$12.99",
  },
  {
    url: "https://images.unsplash.com/photo-1551782450-a2132b4ba21d?w=800&q=80",
    titleKey: "features.items.burgers.title",
    descKey: "features.items.burgers.desc",
    price: "$14.50",
  },
  {
    url: "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=800&q=80",
    titleKey: "features.items.sushi.title",
    descKey: "features.items.sushi.desc",
    price: "$22.00",
  },
  {
    url: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800&q=80",
    titleKey: "features.items.pasta.title",
    descKey: "features.items.pasta.desc",
    price: "$16.80",
  },
  {
    url: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=800&q=80",
    titleKey: "features.items.tacos.title",
    descKey: "features.items.tacos.desc",
    price: "$9.50",
  },
  {
    url: "https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=800&q=80",
    titleKey: "features.items.desserts.title",
    descKey: "features.items.desserts.desc",
    price: "$8.00",
  },
];
