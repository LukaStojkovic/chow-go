 ...
 *
 * Category icons are string keys, not components - this module is consumed by
 * both the web and the native client, which draw from different icon packages.
 * Each client owns the key -> component map.
 */
 ...
 *
 * @type {{ id: string, label: string, value: string, icon: string }[]}
 */
export const CATEGORIES = [
  { id: "all", label: "All", value: "All", icon: "all" },
  { id: "pizza", label: "Pizza", value: "Pizza", icon: "pizza" },
  { id: "burgers", label: "Burgers", value: "Burgers", icon: "burgers" },
  { id: "pasta", label: "Pasta", value: "Pasta", icon: "pasta" },
  { id: "salads", label: "Salads", value: "Salads", icon: "salads" },
  { id: "grill", label: "Grill", value: "Grill", icon: "grill" },
  { id: "sushi", label: "Sushi", value: "Sushi", icon: "sushi" },
  { id: "soups", label: "Soups", value: "Soups", icon: "soups" },
  { id: "breakfast", label: "Breakfast", value: "Breakfast", icon: "breakfast" },
  { id: "desserts", label: "Desserts", value: "Desserts", icon: "desserts" },
  { id: "drinks", label: "Drinks", value: "Drinks", icon: "drinks" },
];
