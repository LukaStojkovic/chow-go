...
export default {
  ...
  state: {
    ...
    allRightsReserved: "{{name}}. All rights reserved.",
  ...
  error: {
    ...
    enableInSettings: "Turn it on in Settings.",
    enableInSettingsOrType: "Turn it on in Settings, or enter your address instead.",
    photoAccess: "Photo access needed",
  ...
  notFound: {
    ...
    orderNow: "Order now",
    mobileBody: "The link may be out of date, or the order it pointed at is gone.",
  },
