...
import { fullScreenModalOptions, sheetOptions, stackScreenOptions } from "@/navigation/transitions";
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <Stack screenOptions={stackScreenOptions({ color })}>
        ...
        <Stack.Screen name="item/[menuItemId]" options={sheetOptions([0.85])} />
        <Stack.Screen name="basket" options={sheetOptions([0.9])} />
